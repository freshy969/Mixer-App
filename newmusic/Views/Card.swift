...
//        self.layer.shadowColor = averageColorFromImage.cgColor
    ...
    fileprivate func setupStackView() {
        ...
        albumImage.anchor(top: playlistNameButtonLabel.bottomAnchor, left: nil, bottom: nil, right: nil, paddingTop: 30, paddingLeft: 0, paddingBottom: 0, paddingRight: 0, width: 235, height: 235)
        albumImage.centerXAnchor.constraint(lessThanOrEqualTo: albumImage.superview!.centerXAnchor).isActive = true
        songNameButtonLabel.anchor(top: albumImage.bottomAnchor, left: self.leftAnchor, bottom: nil, right: nil, paddingTop: 30, paddingLeft: 20, paddingBottom: 10, paddingRight: 0, width: 241, height: 17)
